...
def main():
    ...
    parser.add_argument('--dswa', help="don't-stop-when-arrive flag for settings left and right borders", action='store_true')
    ...
    if args.list:
        ...
        motor_drive.set_left_border(args.left_border, 0, not args.dswa)
    elif args.right_border:
        motor_drive.set_right_border(args.right_border, 0, not args.dswa)
